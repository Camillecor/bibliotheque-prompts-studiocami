...
const OUTILS_SUPPLEMENTAIRES: (Outil & { categorie: string })[] = [
  ...
  },
  {
    ...
    definition: "Programme tes publications sur tous les réseaux depuis un seul calendrier.",
    prix: "freemium",
    notes: { fonctionnalites: 7.5, facilite: 9, valeur: 8, confiance: 8 },
  },
  {
    ...
    definition: "Planification et statistiques détaillées des réseaux, très utilisé en France.",
    prix: "freemium",
    souverain: true,
    notes: { fonctionnalites: 8.5, facilite: 8, valeur: 8.5, confiance: 8 },
  },
  {
    categorie: "Marketing",
    nom: "Brevo",
    ...
    definition: "E-mailing, SMS et automatisations marketing, hébergés en Europe.",
    prix: "freemium",
    souverain: true,
    notes: { fonctionnalites: 8, facilite: 7.5, valeur: 8.5, confiance: 8.5 },
  },
  {
    categorie: "Marketing",
    nom: "Mailchimp",
    ...
    definition: "Newsletters et séquences automatiques, la référence historique de l'e-mailing.",
    prix: "freemium",
    notes: { fonctionnalites: 8, facilite: 8, valeur: 6.5, confiance: 8 },
  },
  {
    categorie: "Marketing",
    nom: "HubSpot",
    ...
    definition: "CRM gratuit avec suivi des prospects, des e-mails et des campagnes.",
    prix: "freemium",
    notes: { fonctionnalites: 9, facilite: 7, valeur: 7, confiance: 8.5 },
  },
  {
    categorie: "Marketing",
    nom: "Typeform",
    ...
    definition: "Formulaires et quiz soignés, pensés pour capter des contacts sans lasser.",
    prix: "freemium",
    notes: { fonctionnalites: 8, facilite: 8.5, valeur: 6.5, confiance: 8 },
  },
  {
    categorie: "Marketing",
    nom: "Tally",
    slug: "tally",
    url: "https://tally.so",
    definition: "Formulaires simples et quasi illimités en gratuit, alternative légère à Typeform.",
    prix: "freemium",
    souverain: true,
    notes: { fonctionnalites: 7.5, facilite: 9, valeur: 9.5, confiance: 8 },
  },
  {
    categorie: "Marketing",
    nom: "Hotjar",
    ...
    definition: "Cartes de chaleur et enregistrements pour voir ce que font tes visiteurs.",
    prix: "freemium",
    notes: { fonctionnalites: 8, facilite: 8, valeur: 7, confiance: 7.5 },
  },
  {
    categorie: "Marketing",
    nom: "Plausible",
    ...
    definition: "Statistiques de site simples, sans cookies, hébergées en Europe.",
    prix: "payant",
    souverain: true,
    notes: { fonctionnalites: 7, facilite: 9, valeur: 8.5, confiance: 9 },
  },
  {
    categorie: "Marketing",
    nom: "AdCreative.ai",
    ...
    definition: "Génère visuels et accroches publicitaires prêts à tester sur tes campagnes.",
    prix: "payant",
    notes: { fonctionnalites: 7.5, facilite: 8, valeur: 6.5, confiance: 7 },
  },
];
