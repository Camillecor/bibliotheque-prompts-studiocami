      ...
      <div className="space-y-5">
        ...
        <EnTetePage
          ...
          actions={
            <button
              ...
              className="inline-flex min-h-11 items-center gap-2 rounded-full bg-[var(--coral)] px-4 text-sm font-semibold text-white"
            >
        ...
        {ouvrirNouveau ? (
          <section className="space-y-4 rounded-2xl border border-border bg-card p-4">
            <div>
              <p className="text-sm font-semibold text-primary">Modèle de départ</p>
