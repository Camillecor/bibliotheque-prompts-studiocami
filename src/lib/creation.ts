  ...
  },
  {
    ...
    construire: () => ({
      ...
      calques: [
        ...
        forme({ x: 72, y: 745, l: 84, h: 84, couleur: "#ffffff", contour: "#3abef9", epaisseurContour: 2, arrondi: 22, opacite: 0.1 }),
        forme({ x: 72, y: 860, l: 84, h: 84, couleur: "#ffffff", contour: "#3abef9", epaisseurContour: 2, arrondi: 22, opacite: 0.1 }),
        forme({ x: 72, y: 975, l: 84, h: 84, couleur: "#ffffff", contour: "#3abef9", epaisseurContour: 2, arrondi: 22, opacite: 0.1 }),
        texte({ texte: "01", x: 72, y: 765, l: 84, h: 42, taille: 29, police: "Archivo Black", couleur: "#3abef9", align: "center" }),
        texte({ texte: "02", x: 72, y: 880, l: 84, h: 42, taille: 29, police: "Archivo Black", couleur: "#3abef9", align: "center" }),
        texte({ texte: "03", x: 72, y: 995, l: 84, h: 42, taille: 29, police: "Archivo Black", couleur: "#3abef9", align: "center" }),
        texte({ texte: "UNE HIÉRARCHIE IMMÉDIATE", x: 190, y: 766, l: 760, h: 42, taille: 28, police: "Hind", graisse: 700, couleur: "#ffffff" }),
        texte({ texte: "DU CALME AUTOUR DU MESSAGE", x: 190, y: 881, l: 760, h: 42, taille: 28, police: "Hind", graisse: 700, couleur: "#ffffff" }),
        texte({ texte: "UN CONTRASTE QUI GUIDE L’ŒIL", x: 190, y: 996, l: 760, h: 42, taille: 28, police: "Hind", graisse: 700, couleur: "#ffffff" }),
        texte({ texte: "ENREGISTRE POUR PLUS TARD  ↗", x: 72, y: 1240, l: 650, h: 42, taille: 22, police: "Hind", graisse: 700, couleur: "#ff6b35", interlettre: 2 }),
      ],
    }),
  },
  {
    ...
    construire: () => ({
      ...
      calques: [
        ...
        forme({ x: 90, y: 1040, l: 900, h: 160, couleur: "#ffffff", contour: "#3abef9", epaisseurContour: 2, arrondi: 30, opacite: 0.1 }),
        forme({ x: 90, y: 1230, l: 900, h: 160, couleur: "#ffffff", contour: "#3abef9", epaisseurContour: 2, arrondi: 30, opacite: 0.1 }),
        forme({ x: 90, y: 1420, l: 900, h: 160, couleur: "#ffffff", contour: "#3abef9", epaisseurContour: 2, arrondi: 30, opacite: 0.1 }),
        texte({
          texte: "01  RECHERCHER",
          x: 135,
          y: 1090,
