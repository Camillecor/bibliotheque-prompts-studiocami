...
export const MODELES: ModeleCreation[] = [
  ...
  },
  {
    ...
    construire: () => ({
      ...
      calques: [
        ...
        texte({ texte: "01  Une intention lisible", x: 110, y: 382, l: 820, h: 70, taille: 34, police: "Instrument Sans", graisse: 700 }),
        texte({ texte: "02  Une hiérarchie évidente", x: 110, y: 556, l: 820, h: 70, taille: 34, police: "Instrument Sans", graisse: 700 }),
        texte({ texte: "03  Une action principale", x: 110, y: 730, l: 820, h: 70, taille: 34, police: "Instrument Sans", graisse: 700 }),
        texte({ texte: "04  Du calme autour du contenu", x: 110, y: 904, l: 820, h: 70, taille: 34, police: "Instrument Sans", graisse: 700 }),
        texte({
  ...
  },
  {
    ...
    construire: () => ({
      ...
      calques: [
        texte({ texte: "SIGNAL FAIBLE", x: 72, y: 72, l: 400, h: 52, taille: 24, police: "Instrument Sans", graisse: 700, couleur: "#050c9c", interlettre: 1 }),
        texte({
          texte: "73%",
          x: 62,
          y: 205,
  ...
  },
  {
    ...
    construire: () => ({
      ...
      fond: { type: "couleur", couleur: "#f7f4ee" },
      calques: [
        forme({ x: 62, y: 62, l: 956, h: 956, couleur: "#f7f4ee", contour: "#050c9c", epaisseurContour: 3, arrondi: 28 }),
        texte({ texte: "PROMPT DESIGN", x: 100, y: 110, l: 600, h: 48, taille: 23, police: "Instrument Sans", graisse: 700, couleur: "#ff6b35", interlettre: 1 }),
        texte({
  ...
  },
  {
    ...
    construire: () => ({
      ...
      calques: [
        ...
        texte({ texte: "STUDIO CAMI IA", x: 620, y: 934, l: 380, h: 42, taille: 20, police: "Instrument Sans", graisse: 700, couleur: "#ffffff", align: "right", interlettre: 1 }),
      ],
    }),
  },
  {
    ...
    construire: () => ({
      ...
      fond: { type: "couleur", couleur: "#ffffff" },
      calques: [
        texte({ texte: "Même idée.\nMeilleure direction.", x: 70, y: 65, l: 900, h: 180, taille: 66, interligne: 1.02 }),
        forme({ x: 70, y: 300, l: 440, h: 570, couleur: "#f1f1f6", arrondi: 24 }),
        forme({ x: 570, y: 300, l: 440, h: 570, couleur: "#050c9c", arrondi: 24 }),
        texte({ texte: "AVANT", x: 105, y: 345, l: 370, h: 52, taille: 24, police: "Instrument Sans", graisse: 700, couleur: "#62636f", interlettre: 1 }),
        texte({ texte: "Une image\njolie mais\nsans message", x: 105, y: 500, l: 340, h: 230, taille: 48, couleur: "#62636f", interligne: 1.08 }),
        texte({ texte: "APRÈS", x: 605, y: 345, l: 370, h: 52, taille: 24, police: "Instrument Sans", graisse: 700, couleur: "#3abef9", interlettre: 1 }),
        texte({ texte: "Un angle\nclair qui fait\nréagir", x: 605, y: 500, l: 340, h: 230, taille: 48, couleur: "#ffffff", interligne: 1.08 }),
        texte({ texte: "CLARTÉ  →  CONTRASTE  →  CONVERSION", x: 70, y: 958, l: 940, h: 48, taille: 22, police: "Instrument Sans", graisse: 700, couleur: "#ff6b35", interlettre: 1 }),
      ],
    }),
  },
  {
    ...
    construire: () => ({
      ...
      calques: [
        texte({ texte: "À TESTER CETTE SEMAINE", x: 90, y: 130, l: 820, h: 60, taille: 28, police: "Instrument Sans", graisse: 700, couleur: "#3abef9", interlettre: 1 }),
        texte({ texte: "3 outils IA\npour créer\nplus juste.", x: 90, y: 360, l: 850, h: 500, taille: 118, couleur: "#ffffff", interligne: 0.98 }),
        ...
        texte({ texte: "01  RECHERCHER", x: 135, y: 1090, l: 800, h: 60, taille: 34, police: "Instrument Sans", graisse: 700, couleur: "#ffffff" }),
        texte({ texte: "02  STRUCTURER", x: 135, y: 1280, l: 800, h: 60, taille: 34, police: "Instrument Sans", graisse: 700, couleur: "#ffffff" }),
        texte({ texte: "03  PRODUIRE", x: 135, y: 1470, l: 800, h: 60, taille: 34, police: "Instrument Sans", graisse: 700, couleur: "#ffffff" }),
        texte({ texte: "@STUDIOCAMIIA", x: 90, y: 1760, l: 800, h: 50, taille: 25, police: "Instrument Sans", graisse: 700, couleur: "#ff6b35", interlettre: 1 }),
      ],
    }),
  },
];
